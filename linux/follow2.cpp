...
static void UpdateAxis(float value, serial::Serial& serialPort)
{
...
void OpenVideo2()
{
    serial::Serial serialPort("/dev/ttyAMA0", 57600);
    
    UpdateAxis(0, serialPort);
